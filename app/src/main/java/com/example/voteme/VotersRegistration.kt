...
class VotersRegistration : AppCompatActivity() {

    private lateinit var binding: ActivityVotersRegistrationBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityVotersRegistrationBinding.inflate(layoutInflater)
