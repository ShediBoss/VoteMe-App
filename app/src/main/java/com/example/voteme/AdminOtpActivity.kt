...
import com.example.voteme.databinding.ActivityAdminOtpBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mCallBacks = object : PhoneAuthProvider.OnVerificationStateChangedCallbacks(){
            ...
            override fun onVerificationFailed(e: FirebaseException) {
                ...
                Toast.makeText(this@AdminOtpActivity, "${e.message}", Toast.LENGTH_SHORT).show()
            }
            ...
            override fun onCodeSent(verificationId: String, token: PhoneAuthProvider.ForceResendingToken) {
                ...
                progressDialog.dismiss()
                Toast.makeText(this@AdminOtpActivity, "Verification code sent...", Toast.LENGTH_SHORT).show()
        ...
        binding.continuePhone.setOnClickListener {
            ...
            if (TextUtils.isEmpty(phone)){
                Toast.makeText(this@AdminOtpActivity, "Please enter phone number", Toast.LENGTH_SHORT).show()
            }
            else {
        ...
        binding.submitBtn.setOnClickListener {
            ...
            if (TextUtils.isEmpty(code)){
                Toast.makeText(this@AdminOtpActivity, "Please enter verification code", Toast.LENGTH_SHORT).show()
